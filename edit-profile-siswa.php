<?php
  ...
  if (isset($_POST['submit'])) {
    $query = mysqli_query($link, "UPDATE siswa SET nama='$_POST[nama]', email='$_POST[email]', alamat='$_POST[alamat]' WHERE nis='$_POST[niss]'");
    if ($query) {
      echo "<script>
              document.location='edit-profile-siswa.php';
            </script>";
    }else {
      echo "<script>
            ...
            <div class="card-body">
              <form method="post">
                <div class="form-group">
                  <label>Nama</label>
                  <input type="hidden" name="niss" value="<?php echo $rowUser['nis']; ?>">
