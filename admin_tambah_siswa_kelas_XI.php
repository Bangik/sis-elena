         ...
         <div class="col-sm">
           <form>
             <div class="form-group row">
               ...
               <div class="col-sm-10">
                 <input type="text" class="form-control" id="adminnama_siswa_XI">
               </div>
             </div>
             <div class="form-group row">
               <label for="inputemail" class="col-sm-2 col-form-label">NIS</label>
               <div class="col-sm-10">
                 <input type="email" class="form-control" id="adminnis_siswa_XI">
               </div>
             </div>
             <div class="form-group row">
             ...
             <div class="form-group row">
               ...
               <div class="col-sm-10">
                 <input type="text" class="form-control" id="adminemail_siswa_XI">
               </div>
             </div>
             <div class="form-group row">
               <label for="inputalamat" class="col-sm-2 col-form-label">Alamat</label>
               <div class="col-sm-10">
                 <input type="text" class="form-control" id="adminalamat_siswa_XI">
               </div>
             </div>
             <div class="form-group row" >
               <label for="deskripsi" class="col-sm-2 col-form-label" >Deskripsi</label>
               <div class="col-sm-10">
                 <input type="text" style="height:100px" class="form-control" id="admindeskripsi_siswa_XI">
               </div>
             </div>
           </form>
         </div>
