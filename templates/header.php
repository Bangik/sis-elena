<?php
  ...
  global $link;
  $nisss = $_SESSION['user'];
  $tampil = mysqli_query($link, "SELECT * FROM siswa where nis='$nisss'");
      ...
      <div class="container">
        ...
        <div class="collapse navbar-collapse" id="navbarNavDropdown">
          <ul class="navbar-nav ml-auto">
            ...
            <li class="nav-item">
              <a class="nav-link fa fa-mortar-board text-white" href="akademik-siswa.php">Akademik</a>
            </li>
            <li class="nav-item dropdown">
              ...
              <div class="dropdown-menu" aria-labelledby="navbarDropdownMenuLink">
                <a class="dropdown-item fa fa-gear" href="edit-profile-siswa.php">Edit Profile</a>
                <a class="dropdown-item fa fa-lock" href="edit-password-siswa.php">Edit Password</a>
